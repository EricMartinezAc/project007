...
import { BasketItem, BasketToggle } from "./index.js";
import { Boundary, Modal } from "../common";
import { CHECKOUT_STEP_1 } from "../../constants/routes";
import Firebase from "../../server/services/firebase.services.js";
import { calculateTotal, displayMoney } from "@/helpers/utils";
import { useDidMount, useModal } from "@/hooks";
import React, { useEffect } from "react";
import { useDispatch, useSelector } from "react-redux";
import { useNavigate, useLocation } from "react-router-dom"; // Reemplazado useHistory por useNavigate
...
const Basket = () => {
  ...
  const navigate = useNavigate(); // Reemplazado useHistory por useNavigate
  ...
  }, [basket.length, didMount]); // Asegúrate de incluir didMount en las dependencias

  const onCheckOut = () => {
    if (basket.length !== 0 && user) {
      document.body.classList.remove("is-basket-open");
      navigate(CHECKOUT_STEP_1); // Reemplazado history.push por navigate
    } else {
      onOpenModal();
    }
  };
